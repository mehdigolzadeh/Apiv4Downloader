...
def find(iterable: typing.Iterable, predicate: typing.Callable):
    """
...
def find_all(iterable: typing.Iterable, predicate: typing.Callable):
    """
...
def get_all(iterable: typing.Iterable, **attributes):
    """
